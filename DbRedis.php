...
//    private $_debugQuery = false;   // podgląd zapytań
    ...
    private function __construct($config = array(), $namespace = null)
    {
        #$this->_debug = true;
        ...
        try {
            ...
            throw new DbRedisException( $e->getMessage() );
        }
    }
    ...
    public static function getInstance( $config = array() )
    {
        ...
        if( !isset(self::$_instance[$namespace]) || !(self::$_instance[$namespace] instanceof self) ) {
...
class DbRedisException extends  Exception {
